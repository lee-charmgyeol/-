...
// ----- EX. 4 : player ------------
        ...
        //step 2-3. moving
   		...
   		if (player_position[turn] > 19)
   			player_position[turn] = 19;
    	...
    	if(player_status[0] != 0 && player_status[1] != 0 && player_status[2] != 0)
    		break;
		...
		else if (turn == 1 && player_status[1] != 0 && player_status[2] != 0){
			int shark_pos = board_stepShark();
			printf("Shark moved to %i\n", shark_pos);
			checkDie();
		}
		else if (turn == 2 && player_status[0] != 0 && player_status[2] != 0){
			int shark_pos = board_stepShark();
			printf("Shark moved to %i\n", shark_pos);
			checkDie();
		}
		else if (turn == 2 && player_status[2] != 0){
			int shark_pos = board_stepShark();
			printf("Shark moved to %i\n", shark_pos);
			checkDie();
		}
